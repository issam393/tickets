# Livrable de reprise, analyse et déploiement

**Projet :** AGCE CRM - Système de gestion des tickets, contacts, e-mails et réunions  
...
- `DOCUMENTATION_MEMOIRE_AGCE_CRM.md`
- `README.md`
- `backend_ticket_gestion/.env.example`
- `backend_ticket_gestion/.gitignore`
- `backend_ticket_gestion/.vscode/settings.json`
- `backend_ticket_gestion/issam.session.sql`
- `backend_ticket_gestion/package-lock.json`
- `backend_ticket_gestion/package.json`
- `backend_ticket_gestion/src/adminInsertion.js`
- `backend_ticket_gestion/src/app.js`
- `backend_ticket_gestion/src/config/db.js`
- `backend_ticket_gestion/src/config/env.js`
- `backend_ticket_gestion/src/database/db.sql`
- `backend_ticket_gestion/src/database/initSchema.js`
- `backend_ticket_gestion/src/index.js`
- `backend_ticket_gestion/src/middleware/auth.js`
- `backend_ticket_gestion/src/middleware/roleCheck.js`
- `backend_ticket_gestion/src/middleware/security.js`
- `backend_ticket_gestion/src/modules/auth/auth.controllers.js`
- `backend_ticket_gestion/src/modules/auth/auth.repository.js`
- `backend_ticket_gestion/src/modules/auth/auth.routes.js`
- `backend_ticket_gestion/src/modules/auth/auth.services.js`
- `backend_ticket_gestion/src/modules/auth/auth.validation.js`
- `backend_ticket_gestion/src/modules/clientEmails/clientEmails.controllers.js`
- `backend_ticket_gestion/src/modules/clientEmails/clientEmails.repository.js`
- `backend_ticket_gestion/src/modules/clientEmails/clientEmails.routes.js`
- `backend_ticket_gestion/src/modules/clientEmails/clientEmails.services.js`
- `backend_ticket_gestion/src/modules/clientEmails/gmailSync.services.js`
- `backend_ticket_gestion/src/modules/comments/comments.controllers.js`
- `backend_ticket_gestion/src/modules/comments/comments.repository.js`
- `backend_ticket_gestion/src/modules/comments/comments.routes.js`
- `backend_ticket_gestion/src/modules/comments/comments.services.js`
- `backend_ticket_gestion/src/modules/contacts/contacts.controllers.js`
- `backend_ticket_gestion/src/modules/contacts/contacts.repository.js`
- `backend_ticket_gestion/src/modules/contacts/contacts.routes.js`
- `backend_ticket_gestion/src/modules/contacts/contacts.services.js`
- `backend_ticket_gestion/src/modules/dashboard/dashboard.controllers.js`
- `backend_ticket_gestion/src/modules/dashboard/dashboard.repository.js`
- `backend_ticket_gestion/src/modules/dashboard/dashboard.routes.js`
- `backend_ticket_gestion/src/modules/dashboard/dashboard.services.js`
- `backend_ticket_gestion/src/modules/employees/employees.controllers.js`
- `backend_ticket_gestion/src/modules/employees/employees.repository.js`
- `backend_ticket_gestion/src/modules/employees/employees.routes.js`
- `backend_ticket_gestion/src/modules/employees/employees.services.js`
- `backend_ticket_gestion/src/modules/employees/employees.validation.js`
- `backend_ticket_gestion/src/modules/meetingRooms/meetingRooms.repository.js`
- `backend_ticket_gestion/src/modules/meetingRooms/meetingRooms.routes.js`
- `backend_ticket_gestion/src/modules/meetings/meetings.controllers.js`
- `backend_ticket_gestion/src/modules/meetings/meetings.repository.js`
- `backend_ticket_gestion/src/modules/meetings/meetings.routes.js`
- `backend_ticket_gestion/src/modules/meetings/meetings.services.js`
- `backend_ticket_gestion/src/modules/messages/messages.repository.js`
- `backend_ticket_gestion/src/modules/organizations/organizations.controllers.js`
- `backend_ticket_gestion/src/modules/organizations/organizations.repository.js`
- `backend_ticket_gestion/src/modules/organizations/organizations.routes.js`
- `backend_ticket_gestion/src/modules/organizations/organizations.services.js`
- `backend_ticket_gestion/src/modules/rooms/rooms.controllers.js`
- `backend_ticket_gestion/src/modules/rooms/rooms.repository.js`
- `backend_ticket_gestion/src/modules/rooms/rooms.routes.js`
- `backend_ticket_gestion/src/modules/rooms/rooms.services.js`
- `backend_ticket_gestion/src/modules/tickets/tickets.controllers.js`
- `backend_ticket_gestion/src/modules/tickets/tickets.repository.js`
- `backend_ticket_gestion/src/modules/tickets/tickets.routes.js`
- `backend_ticket_gestion/src/modules/tickets/tickets.services.js`
- `backend_ticket_gestion/src/modules/tickets/tickets.validation.js`
- `backend_ticket_gestion/src/socket/auth.middleware.js`
- `backend_ticket_gestion/src/socket/chat.handlers.js`
- `backend_ticket_gestion/src/socket/index.js`
- `backend_ticket_gestion/src/utils/apiResponse.js`
- `backend_ticket_gestion/src/utils/blacklist.js`
- `backend_ticket_gestion/src/utils/roomAccess.js`
- `frontend_ticket_gestion/.env.example`
- `frontend_ticket_gestion/.gitignore`
- `frontend_ticket_gestion/README.md`
- `frontend_ticket_gestion/components.json`
- `frontend_ticket_gestion/eslint.config.js`
- `frontend_ticket_gestion/index.html`
- `frontend_ticket_gestion/jsconfig.json`
- `frontend_ticket_gestion/package-lock.json`
- `frontend_ticket_gestion/package.json`
- `frontend_ticket_gestion/src/App.css`
- `frontend_ticket_gestion/src/App.jsx`
- `frontend_ticket_gestion/src/components/auth/RoleBasedRoute.jsx`
- `frontend_ticket_gestion/src/components/auth/RoleRedirect.jsx`
- `frontend_ticket_gestion/src/components/ui/AccessDenied/AccessDenied.css`
- `frontend_ticket_gestion/src/components/ui/AccessDenied/AccessDenied.jsx`
- `frontend_ticket_gestion/src/components/ui/Dashboard/ManagerDaschboard.css`
- `frontend_ticket_gestion/src/components/ui/Dashboard/ManagerDaschboard.jsx`
- `frontend_ticket_gestion/src/components/ui/Dashboard/PKIDashboard.css`
- `frontend_ticket_gestion/src/components/ui/Dashboard/PKIDashboard.jsx`
- `frontend_ticket_gestion/src/components/ui/Dashboard/SDHomeDashboard.css`
- `frontend_ticket_gestion/src/components/ui/Dashboard/SDHomeDashboard.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/ContactDetails/OrganizationDetails.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/ContactDetails/OrganizationDetails.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Contacts.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Contacts.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/CreateTicket.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/CreateTicket.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Meetings.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Meetings.tsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Messages.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Messages.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Tickets/TicketDetails.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Tickets/TicketDetails.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Tickets/Tickets.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Tickets/Tickets.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/Tickets/TicketsContents.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/UserIdentityBar.css`
- `frontend_ticket_gestion/src/components/ui/DashboardComposentes/UserIdentityBar.jsx`
- `frontend_ticket_gestion/src/components/ui/DashboardContent.jsx`
- `frontend_ticket_gestion/src/components/ui/ProfileReview/ProfilePage.css`
- `frontend_ticket_gestion/src/components/ui/ProfileReview/ProfilePage.jsx`
- `frontend_ticket_gestion/src/components/ui/SideBar.css`
- `frontend_ticket_gestion/src/components/ui/SideBar.jsx`
- `frontend_ticket_gestion/src/components/ui/ThemeToggle.css`
- `frontend_ticket_gestion/src/components/ui/ThemeToggle.jsx`
- `frontend_ticket_gestion/src/components/ui/dashboardContent.css`
- `frontend_ticket_gestion/src/components/ui/shade/badge.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/button.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/card.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/chart.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/dialog.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/input.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/label.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/progress.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/select.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/separator.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/table.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/tabs.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/textarea.jsx`
- `frontend_ticket_gestion/src/components/ui/shade/tooltip.jsx`
- `frontend_ticket_gestion/src/hooks/useChatRoom.js`
- `frontend_ticket_gestion/src/index.css`
- `frontend_ticket_gestion/src/lib/apiConfig.js`
- `frontend_ticket_gestion/src/lib/authAccess.js`
- `frontend_ticket_gestion/src/lib/themePreference.js`
- `frontend_ticket_gestion/src/lib/utils.js`
- `frontend_ticket_gestion/src/main.jsx`
- `frontend_ticket_gestion/src/pages/dashboard/AdminDashboard.css`
- `frontend_ticket_gestion/src/pages/dashboard/AdminDashboard.jsx`
- `frontend_ticket_gestion/src/pages/dashboard/PKIDashboard.css`
- `frontend_ticket_gestion/src/pages/dashboard/PKIDashboard.jsx`
- `frontend_ticket_gestion/src/pages/register/Register.css`
- `frontend_ticket_gestion/src/pages/register/Register.jsx`
- `frontend_ticket_gestion/vite.config.js`
- `issam.session.sql`
