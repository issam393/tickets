...
function TicketDetails({ ticketId, onBack }) {
  ...
  const [discussionsCollapsed, setDiscussionsCollapsed] = useState(false); // For the second card
    ...
    <div className="ticket-detail-page">
      <main className="ticket-detail-main">
        ...
        <div className="ticket-detail-container">
          ...
          {/* COMMENTS & MEETINGS CARD (with comment input) */}
          ...
          {/* DISCUSSIONS & MEETINGS CARD (separate, internal team) */}
          <GlassCard className="discussions-card">
